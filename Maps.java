...
public class Maps {
	...
	public Maps(Handler handler, InputStream in) {
		...
		// i = 4722; j = 160;
		// entityManager.addEntity(new slantTree(handler, i, j, 0));

		entityManager.addEntity(new puffyBush(handler, 3540 + 64 * 4, 200, -13));
		// entityManager.addEntity(new puffyBush(handler, 3540 + 64*4, 250,
		// -13));

		j = 64;
		i = 1800;
		//entityManager.addEntity(new House2(handler, 3543, 63));
