...
public abstract class Creature extends Entity {
	...
	public static int DEFAULT_CREATURE_WIDTH = 42;
	public static int DEFAULT_CREATURE_HEIGHT = 42;
	...
	public void moveX() {
		...
		if (xMove > 0) { // moving right
			...
			int tx = (int) (x + xMove + bounds.x + bounds.width) / Tile.TILEWIDTH; // get
																					// x
																					// coordinate
																					// of
																					// the
			...
			int tx = (int) (x + xMove + bounds.x) / Tile.TILEWIDTH; // get x
																	// coordinate
																	// of the
																	// tile
