...
public class flatRock5 extends StaticEntity{

	public flatRock5(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		...
		if (handler.getMap().getEntityManager().getPlayer().flagFR5== 0){
			g.setColor(Color.BLACK);
			//g.drawString("MOVING", 330, 120);
			//4
			g.drawString("4", 330, 120);
			if(handler.getMap().getEntityManager().getPlayer().flagCheck2== 0){
