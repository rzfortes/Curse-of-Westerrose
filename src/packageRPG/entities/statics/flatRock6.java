...
public class flatRock6 extends StaticEntity{

	public flatRock6(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		...
		if (handler.getMap().getEntityManager().getPlayer().flagFR6== 0){
			g.setColor(Color.BLACK);
			//g.drawString("MOVING", 330, 120);
			//4
			g.drawString("LOVE <3", 330, 120);
		}
	}
