...
public class hole extends StaticEntity{
	...
	public hole(Handler handler, float x, float y, int scale) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.hole, (int)(x -handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
